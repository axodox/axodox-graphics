...
namespace Axodox::Graphics::D3D12
{
  GraphicsPipelineStateDefinition::operator D3D12_GRAPHICS_PIPELINE_STATE_DESC() const
  {
    D3D12_GRAPHICS_PIPELINE_STATE_DESC result{
      ...
      .VS = D3D12_SHADER_BYTECODE(*VertexShader),
      .PS = D3D12_SHADER_BYTECODE(*PixelShader),
      .DS = D3D12_SHADER_BYTECODE(*DomainShader),
      .HS = D3D12_SHADER_BYTECODE(*HullShader),
      .GS = D3D12_SHADER_BYTECODE(*GeometryShader),
      ...
      .PrimitiveTopologyType = D3D12_PRIMITIVE_TOPOLOGY_TYPE(InputTopology),
